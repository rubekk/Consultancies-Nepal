...
import universitiesData from "$lib/data/universities-short.json"
...
export { filterData, convertToText, updateSpecialization, updateCountry, updateDegree, updateFee, updateExam, updateTime, updateScholarship, updateDuration };
